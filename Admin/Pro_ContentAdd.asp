...
<tr>
  <td width="10%" align="right" class="Right">名称：</td>
  <td class="Right">
...
<tr>
  ...
  <textarea name="ShopContent" id="ShopContent" cols="60" rows="10"></textarea>
  </td>
</tr>
<tr>
  <td class="Right" align="right">链接地址：</td>
  <td colspan="3" class="Right"><input type="text" id="ShopFactory" name="ShopFactory" value="" class="Input200px"/></textarea>
  </td>
</tr>
<!--<tr>
