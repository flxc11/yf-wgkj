...
If Action="Save" Then
	...
	NavImages=ReplaceBadChar(Trim(Request("NavImages")))	
...
<tr>
  ...
  <td colspan="3" class="Right"><div class="float_left_250txt"><input type="text" id="NavImages" name="NavImages" value="" class="Input200px"/>    
