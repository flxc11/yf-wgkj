...
If Action="Save" Then
	...
	NewsSummary=ReplaceBadChar(Trim(Request("NewsSummary")))
...
<td colspan="3" class="Right"><input type="text" id="Video" name="Video" value="" class="Input200px" readonly="readonly" style="width:370px; background-color:#F5F5F5;"/> <a href="javascript:OpenImageBrowser('Video');">浏览...</a>(上传FLV格式)</td>
</tr>
<tr>
...
<tr>
  ...
  <td colspan="3" class="Right" style="padding:5px;"><textarea name="NewsSummary" id="" cols="100" rows="5"></textarea></td>
</tr>
<%if Request.Cookies("CNVP_CMS2")("SiteVersion")="Chiness" or Request.Cookies("CNVP_CMS2")("SiteVersion")="CAndE" then%>
<tr>
