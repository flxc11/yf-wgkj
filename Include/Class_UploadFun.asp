<%
Class Class_UploadFun

	Private m_TotalSize,m_MaxSize,m_FileType,m_SavePath2,m_AutoSave,m_Error,m_Charset
	Private m_dicForm,m_binForm,m_binItem,m_strDate,m_lngTime
	Public	FormItem,FileItem

	Public Property Get Version
		Version="捷点科技无组件上传2.0"
	End Property
	...
	Public Property Get SavePath
		SavePath=m_SavePath2
	End Property
	Public Property Let SavePath(strPath)
		m_SavePath2=Replace(strPath,chr(0),"")
	End Property
	...
	Private Sub Class_Initialize
		...
		m_TotalSize= 0
		m_MaxSize  = 30720000
		m_FileType = "jpg/gif/png/jpeg/asf/doc/txt/pdf|flv|swf|avi"
		m_SavePath2 = "/Admin/FunUploadFile/"&Year(dtmNow)&Right("0"&Month(dtmNow),2)&"/"
		m_AutoSave = 0
		...
		If m_dicFSO.FolderExists(Server.MapPath(m_SavePath2)) = False Then
			m_dicFSO.CreateFolder Server.MapPath(m_SavePath2)
		End If
				...
				if m_binItem.Size<>0 then
					...
					if m_AutoSave<>2 then
						...
						if intTemp=0 then
							...
							m_binItem.SaveToFile Server.MapPath(m_SavePath2&strFnam),2
