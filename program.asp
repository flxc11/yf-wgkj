...
<%
	...
	if ClassID="" or IsNumEric(ClassID)=false then
		...
		Sql1 = "select top 1 * from newsclass where NavParent=2 order by ID asc"
...
<body class="inxBody">
	...
	<div class="wrap clearfix">
		<div class="wrap-r">
			<div class="pro-ban"><img src="images/imgprogram.jpg" alt=""></div>
			<div class="third-nav">
	            ...
	            <div class="cnvp-tab-panle C program">
					...
					%>
					<dl>
						<dt><span><a href="showprogram.asp?ID=<%=Rs("ID")%>" target="_blank">进入方案</a></span><%=GetNewsTitle(Rs("ID"),20)%></dt>
		...
		<div class="wrap-l">
			<div class="column">
				<h2 class="h2">解决方案<em>Program</em></h2>
